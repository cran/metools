...
#'
gm.col=function(data,ncolx,ncoly,ntimes,title,xlab=NULL,ylab=NULL,div100=FALSE,
                  percent=FALSE,fontsize=0,cserie='#17B221',clines='white',
                  ctext='white',cbackground='#141414',cbserie=cbackground){
    (g=metools::p.col(utils::tail(data,n=ntimes),utils::tail(data[[ncolx]],n=ntimes),
