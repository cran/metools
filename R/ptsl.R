...
#'
p.tsl=function(data,xaxis,yaxis,dateformat='%Y-%m',datebreaks="1 month",ybreaks= 10,percent=FALSE,
    ...
    if(percent==TRUE){
        g=(ggplot2::ggplot(stats::na.exclude(data), ggplot2::aes(x = xaxis , y = yaxis )) + ggplot2::geom_line(color=cserie,lwd=lwdserie) +
